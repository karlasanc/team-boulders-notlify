...
This is a solution to the Grammerhub Entertainment Web App Challenge.
...
- [Notlify](#notlify)
  ...
  - [Overview](#overview)
    - [About the project / The challenge](#about-the-project--the-challenge)
...
- Build project as a full-stack application
- Create an auth flow with the provide authentication screen (sign-up/login) designs
...
- install node on your local system: [node.js](https://nodejs.org/en)
...
2. Install NPM packages
   ...
   npm install
   ```
3. Create a `.env` file in your root folder and enter your API and email address.
   ```js
   RESEND_API_KEY=enter-api-key-here
   FROM_EMAIL=email@example.com
   ```
4. Navigate to your project folder and initiate next application.
   ```sh
   npm run dev
   ```
